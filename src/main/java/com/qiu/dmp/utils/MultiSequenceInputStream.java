...
public class MultiSequenceInputStream extends InputStream {
     ...
     * @see Enumeration
     */
    public MultiSequenceInputStream(Enumeration<? extends InputStream> e) {
        this.e = e;
        try {
            nextStream();
     ...
     */
    public MultiSequenceInputStream(InputStream s1, InputStream s2) {
    ...
    public MultiSequenceInputStream(List<InputStream> list) {
        Vector<InputStream> v = new Vector<>(list.size());
        //  InputStream sis = new ByteArrayInputStream(content.getBytes());
        ...
        try {
            ...
            throw new Error("MultiSequenceInputStream error");
        }
    }
