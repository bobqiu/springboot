var EXAMPLES = [{id: "area-rainfall", title: "雨量流量关系图", type: "line"}, {
    id: "area-simple",
    title: "大数据量面积图",
    type: "line"
    ...
    title: "柱状图动画延迟",
    type: "bar"
}, {id: "bar-brush", title: "柱状图框选", type: "bar"}, {
    id: "bar-negative",
    title: "正负条形图",
    type: "bar"
    ...
    title: "堆叠柱状图",
    type: "bar"
}, {id: "bar-tick-align", title: "坐标轴刻度与标签对齐", type: "bar"}, {
    id: "bar-waterfall",
    ...
    title: "堆叠条形图",
    type: "bar"
}, {id: "bar-y-category", title: "世界人口总量 - 条形图", type: "bar"}, {
    id: "bar1",
    title: "某地区蒸发量和降水量",
    type: "bar"
    ...
    title: "动态数据 + 时间坐标轴",
    type: "line"
}, {id: "effectScatter-bmap", title: "全国主要城市空气质量 - 百度地图", type: "scatter"}, {
    ...
    title: "雨量流量关系图",
    type: "line"
}, {id: "heatmap-bmap", title: "热力图与百度地图扩展", type: "heatmap"}, {
    id: "heatmap-cartesian",
    title: "笛卡尔坐标系上的热力图",
    type: "heatmap"
}, {id: "heatmap-large-piecewise", title: "热力图 - 颜色的离散映射", type: "heatmap"}, {
    id: "heatmap-large",
    title: "热力图 - 2w 数据",
    type: "heatmap"
    ...
    type: "scatter"
}, {id: "map-province", title: "34 省切换查看", type: "map"}, {
    id: "map-usa",
    ...
    title: "Map World",
    type: "0"
}, {id: "mix-line-bar", title: "折柱混合", type: "bar"}, {
    ...
    title: "环形图",
    type: "pie"
}, {id: "pie-nest", title: "嵌套环形图", type: "pie"}, {id: "pie-pattern", title: "饼图纹理", type: "pie"}, {
    id: "pie-roseType",
    title: "南丁格尔玫瑰图",
    type: "pie"
    ...
    title: "多雷达图",
    type: "radar"
}, {id: "radar", title: "基础雷达图", type: "radar"}, {id: "radar2", title: "浏览器占比变化", type: "radar"}, {
    id: "sankey-energy",
    ...
    type: "scatter"
}, {id: "scatter-single-axis", title: "单轴散点图", type: "scatter"}, {
    id: "scatter-weibo",
    title: "微博签到数据点亮中国",
    type: "scatter"
