(function (e, t, n) {
    (function (e) {
        ...
        r.SPFormatClass = u = o({
            fre: /\{\{([\w.]+?)(:(.+?))?\}\}/g, precre: /(\w+)\.(\d+)/, init: function (e, t) {
                this.format = e;
                this.fclass = t
        ...
        r.fn.sparkline._base = o({
            disabled: false, init: function (e, t, i, s, o) {
                this.el = e;
                this.$el = r(e);
                this.values = t;
                this.options = i;
        ...
        r.fn.sparkline.line = x = o(r.fn.sparkline._base, {
            type: "line", init: function (e, t, n, r, i) {
        ...
        r.fn.sparkline.bar = T = o(r.fn.sparkline._base, S, {
            type: "bar", init: function (e, i, s, o, u) {
        ...
        r.fn.sparkline.tristate = N = o(r.fn.sparkline._base, S, {
            type: "tristate", init: function (e, t, i, s, o) {
        ...
        r.fn.sparkline.discrete = C = o(r.fn.sparkline._base, S, {
            type: "discrete", init: function (e, i, s, o, u) {
        ...
        r.fn.sparkline.bullet = k = o(r.fn.sparkline._base, {
            type: "bullet", init: function (e, r, i, s, o) {
                var u, a, f;
        ...
        r.fn.sparkline.pie = L = o(r.fn.sparkline._base, {
            type: "pie", init: function (e, n, i, s, o) {
                var u = 0, a;
        ...
        r.fn.sparkline.box = A = o(r.fn.sparkline._base, {
            type: "box", init: function (e, t, n, i, s) {
                ...
                var e = [{field: "lq", value: this.quartiles[0]}, {field: "med", value: this.quartiles[1]}, {
                    field: "uq",
        ...
        D = o({
            _pxregex: /(\d+)(px)?\s*$/i, init: function (e, t, n) {
                if (!e) {
                    return
                }
                this.width = e;
